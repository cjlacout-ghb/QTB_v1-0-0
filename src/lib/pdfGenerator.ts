...
export function generatePDF(data: PDFExportData): void {
    ...
    const footerY = 275;
    doc.text('Generated by TQB Calculator - WBSC Rule C11 Tie-Breaker', pageWidth / 2, footerY, { align: 'center' });
    doc.text('Dev by Cristian Lacout - WBSC Int\'l TC', pageWidth / 2, footerY + 5, { align: 'center' });
    doc.text('2026 - all rights reserved', pageWidth / 2, footerY + 10, { align: 'center' });
